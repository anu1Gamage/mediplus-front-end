...
export default function AddPrescribe() {
  ...
  const appendInput_director = () => {
    ...
    setDiirectors_Array([
      ...directors_array,
      { pharmacyItemId: 0, numberOfDays: 0, noOfRounds: 0, numberOfTablets: 0 },
    ]);
  };
          ...
          >
            ...
            >
                    ...
                    <Grid xs={5} item>
                      <FormControl fullWidth margin="dense">
                        <TextField
                          ...
                          required
                          type="number"
                          label="Number of Rounds PerDay"
                          name="numberOfRounds"
                          size="small"
                          value={input.numberOfRounds || 0}
                          onChange={e=>onChangeValues(index,e)}
                          InputLabelProps={{ shrink: true }}
                          InputProps={{
                            endAdornment: index + 1 ===
                    ...
                    <Grid xs={5} item>
                      <FormControl fullWidth margin="dense">
                        <TextField
                          ...
                          required
                          type="number"
                          label="Number of Tablets PerRounds"
                          name="numberOfTablets"
                          size="small"
                          value={input.numberOfTablets || 0}
                          onChange={e=>onChangeValues(index,e)}
                          InputLabelProps={{ shrink: true }}
                          InputProps={{
                            endAdornment: index + 1 ===
              ...
              <Button
                ...
                variant="contained"
                sx={{ mt: 3, mb: 2, borderRadius: 5, float: "right" }}
                disabled={directors_array[0].numberOfDays == 0 || directors_array[0].pharmacyItemId == 0 || directors_array[0].numberofRounds == 0 || directors_array[0].numberofTablets == 0?true:false}
              >
                submit
              </Button>
            </Box>
